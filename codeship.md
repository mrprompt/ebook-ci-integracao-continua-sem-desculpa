...
![Codeship - Paralell Build](../assets/codeship-parallelci.png)
...
![Codeship - DashBoard](../assets/shot-codeship-dashboard.png)
...
![Codeship - Configurando 1](../assets/shot-codeship-environments.png)
...
![Codeship - Configurando 2](../assets/shot-codeship-tests.png)
...
artigo futuro.
![Codeship - Configurando 3](../assets/shot-codeship-deploy.png)

Finalizando a configuração do **Deploy**, você também pode configurar notificações:
![Codeship - Configurando 3](../assets/shot-codeship-hooks.png)
![Codeship - Configurando 3](../assets/shot-codeship-hooks-2.png)
...
![Codeship - Configurando 3](../assets/shot-codeship-config-environment.png)

E se tudo der certo - ou mesmo se der tudo errado -, você pode conferir os detalhes do build:
![Codeship - Configurando 3](../assets/shot-codeship-success.png)
...
![Codeship - Badge](../assets/shot-codeship-badge.png)
